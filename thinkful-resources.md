# Thinkful web development resources

The following links are resources gained while attending Thinkfuls Full stack web dev bootcamp. I will organize at a later date.

1. [MDN Web Docs](https://developer.mozilla.org/en-US/)
  - [Form input types](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Form_<input>_types)
  - [Shay Howe's lesson on building forms](https://learn.shayhowe.com/html-css/building-forms/)
...
11. [CSS Spheres](https://cssanimation.rocks/spheres/)
12.[WebGL Earth](http://www.webglearth.org/)
